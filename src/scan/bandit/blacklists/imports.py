...
def gen_blacklist():
    ...
    sets.append(
        utils.build_conf_dict(
            ...
            issue.Cwe.IMPROPER_ACCESS_CONTROL
            ["pip"],
            "The pip module is being imported. Specify dependencies in the official manner.",
            "HIGH",
        )
    )
    ...
    sets.append(
        utils.build_conf_dict(
            ...
            issue.Cwe.DESERIALIZATION_OF_UNTRUSTED_DATA
            ["tarfile"],
            "The tarfile module is being imported. Consider possible security implications associated with tarfile module.",
            "LOW",
        )
    )
    ...
    sets.append(
        utils.build_conf_dict(
            ...
            issue.Cwe.DESERIALIZATION_OF_UNTRUSTED_DATA
            ["zipfile"],
            "The zipfile module is being imported. Consider possible security implications associated with zipfile module.",
            "LOW",
        )
    )
    ...
    sets.append(
        utils.build_conf_dict(
            ...
            issue.Cwe.IMPROPER_INPUT_VALIDATION
            ["importlib"],
            "The importlib module is being imported. Use standard, secure import methods.",
            "LOW",
        )
    )
    ...
    sets.append(
        utils.build_conf_dict(
            ...
            issue.Cwe.IMPROPER_INPUT_VALIDATION
            ["imp"],
            "The imp module is being imported. Use standard, secure import methods.",
            "LOW",
        )
    )
    ...
    sets.append(
        utils.build_conf_dict(
            ...
            issue.Cwe.IMPROPER_INPUT_VALIDATION
            ["pkgutil"],
            "The pkgutil module is being imported. Use standard, secure import methods.",
            "LOW",
        )
    )
    ...
    sets.append(
        utils.build_conf_dict(
            ...
            issue.Cwe.OS_COMMAND_INJECTION,
            ["runpy"],
            "The runpy module is being imported. Use standard, secure import methods.",
            "MEDIUM",
        )
    )
    ...
    sets.append(
        utils.build_conf_dict(
            ...
            issue.Cwe.IMPROPER_ACCESS_CONTROL
            ["ctypes"],
            "The ctypes module is being imported. Interacting with shared libraries might allow for code injection.",
            "HIGH",
        )
    )
    ...
    sets.append(
        utils.build_conf_dict(
            ...
            issue.Cwe.OS_COMMAND_INJECTION,
            ["os.system"],
            "os.system calls without proper validation. Spawning processes can be used for malicious activities.",
            "HIGH",
        )
    )
    ...
    sets.append(
        utils.build_conf_dict(
            ...
            issue.Cwe.OS_COMMAND_INJECTION,
            ["pty"],
            "The pty module is being imported. Pseudo-terminals could be used for hiding command execution.",
            "HIGH",
        )
    )
    ...
    sets.append(
        utils.build_conf_dict(
            "import_requests_urlib",
            "B826",
            issue.Cwe.IMPROPER_ACCESS_CONTROL,
            ["requests.urlib"],
            "The requests.urlib module is being imported. Fetching external resources might introduce vulnerabilities from untrusted sources.",
            "HIGH",
        )
    )
    ...
    sets.append(
        utils.build_conf_dict(
            ...
            issue.Cwe.IMPROPER_ACCESS_CONTROL,
            ["http.server"],
            "The http.server module is being imported. Running an HTTP server might introduce vulnerabilities.",
            "HIGH",
        )
    )
